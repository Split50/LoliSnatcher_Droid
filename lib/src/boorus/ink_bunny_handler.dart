...
class InkBunnyHandler extends BooruHandler {
  ...
  String makeURL(String tags) {
    ...
    return "${booru.baseURL}/api_search.php?output_mode=json&sid=$sessionToken&text=$tagStr${artist.isEmpty ? '' : '&username=$artist'}${poolId.isEmpty ? '' : '&pool_id=$poolId'}&get_rid=yes&type=1,2,3,4,8,9,13,14&random=${random ? "yes" : "no"}&submission_ids_only=yes${order.isEmpty ? '' : '&orderby=$order'}&page=$pageNum";
  }
